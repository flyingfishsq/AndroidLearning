...
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSelectedTextView = v.findViewById(R.id.fragment_remote_control_selectedTextView);
        mWorkingTextView = v.findViewById(R.id.fragment_remote_control_workingTextView);
